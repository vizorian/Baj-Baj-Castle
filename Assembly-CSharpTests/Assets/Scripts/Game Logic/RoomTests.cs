...
namespace Tests
{
    ...
    public class RoomTests
    {
        ...
        public void RoomTest()
        {
            ...
            {
                new TileData(0, 0, TileType.None),
                new TileData(0, 1, TileType.None),
                new TileData(1, 0, TileType.None),
                new TileData(1, 1, TileType.None)
            };
            ...
            Assert.AreEqual(1, room.XMax);
            Assert.AreEqual(1, room.YMax);
        }
